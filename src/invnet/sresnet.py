...
from .ssiresnet_block import conv_ssiresnet_block

class conv_siResNet(nn.Module):
    def __init__(self, in_shape, nBlocks, nStrides, nChannels, init_ds=2, inj_pad=0,
                 ...
                 n_power_iter=5,
                 block=conv_siresnet_block,
                 actnorm=True, learn_prior=True,
                 nonlin="relu"):
        super(conv_siResNet, self).__init__()
        ...
        print('')
        print(' == Building siResNet %d == ' % (sum(nBlocks) * 3 + 1))

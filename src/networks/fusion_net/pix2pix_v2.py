...
class Pix2PixModel(BaseModel):
    ...
    def __init__(self, opt, inet=None):
        ...
        self.loss_names = ['G_Z', 'G_GAN', 'G_L1', 'D_real', 'D_fake', 'G_KD', 'Z2']
    ...
    def backward_G(self, z_loss):
        ...
        self.loss_G = self.loss_G_GAN + self.loss_G_Z + 10 * self.loss_G_KD + self.loss_G_L1 + self.loss_G_Z 
    ...
    def optimize_G(self, z_loss):
        # update G
        self.set_requires_grad(self.netD, False)  # D requires no gradients when optimizing G
        self.optimizer_G.zero_grad()        # set G's gradients to zero
        self.backward_G(z_loss)                   # calculate graidents for G

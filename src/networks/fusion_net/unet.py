...
class UnetModel(BaseModel):
    ...
    def __init__(self, opt, inet=None):
        ...
        self.loss_names = ['G_L1', 'G', 'G_Z', 'G_KD']
    ...
    def rb_loss(self, x, y, with_kd=False):
        (out_x, z_x), _ = self.inet(x, with_latent=True)
        (out_y, z_y), _ = self.inet(y, with_latent=True)
        if with_kd:
    ...
    def backward_G(self):
        ...
        self.loss_G_KD *= 10
        self.loss_G = self.loss_G_Z + self.loss_G_KD + 0.1 * self.loss_G_L1
